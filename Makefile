...
build:
	...
	echo '<p>For more information, please visit the <a href="https://carbon-transparency.com/">PACT website</a> and our <a href="https://github.com/wbcsd">WBCSD GitHub repository</a>.</p>' >> index.html
